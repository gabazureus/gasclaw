...
export const MUTATING: ReadonlySet<string> = new Set(['eval', 'poc', 'enable', 'disable', 'drain', 'step', 'tools', 'capability', 'battery', 'interval', 'budget', 'succeed', 'automate', 'evaluate', 'rebase', 'sync', 'inherit', 'succession', 'measure', 'lineage']);
