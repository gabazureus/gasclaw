...
| 33 | Entrega da chave ao filho | ❌ **MEDIDO E REPROVADO (P27, dev v126)**: o filho executa (`code 200`, consentimento dado) mas o motor recusa o token dele (`401`, página de login) — a chamada é barrada pela PLATAFORMA antes de chegar ao nosso código. O desenho de *pull* não funciona como especificado. Quatro opções e a recomendação estão na [ADR-040](docs/adr/040-isolamento-e-privilegio.md#medido-p27-dev-v126-2026-09-20-o-filho-não-alcança-o-motor) | **decisão do dono** |
