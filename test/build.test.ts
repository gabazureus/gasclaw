...
const GLOBALS = ['doGet', 'onMessage', 'onCardClick', 'onAddToSpace', 'onRemoveFromSpace', 'settingsState', 'saveKey', 'addAgent', 'createAgent', 'removeAgent', 'makeDefault', 'testAgent', 'setRuntimeEnabled', 'pocUrlFetchTimeout', 'chatSend', 'chatClick'];
