...
>
> 👆 **O clique no cartão responde na hora, e o trabalho vem logo atrás:** o Google Chat dá 30 segundos
> para um clique, e o turno do agente não cabe nesse tempo — o cartão mostrava "gasclaw não processou sua
> solicitação" em vermelho enquanto o trabalho era feito duas vezes em paralelo. Agora o clique só registra
> a sua decisão e confirma no ato; a continuação chega como mensagem nova em até um minuto. Custa a mesma
> chamada ao modelo de antes. E clicar num cartão de um pedido **já encerrado** passa a dizer que ele
> acabou, em vez de acusar o arquivo de ter sido mexido por fora.
>
...
>
> ⚡ **O minuto parado ficou mais barato:** quando não há nada a registrar, o gatilho de 1 minuto deixa de
> tomar a trava global (a mesma que o seu "Aprovar" precisa pegar) e de reler as configurações inteiras só
> para descobrir que não há nada. Você sente isso como um "Aprovar" que não diz mais "ocupado".
